...
async function syncTenantPersonalInfo({
  oldPhoneNumber,
  body,
  currentTenant,
  transaction = null,
  ...
  const personalInfoUpdate = {
    fullName:
      body.fullName !== undefined ? body.fullName : currentTenant.fullName,
    ...
    tin:
      Object.prototype.hasOwnProperty.call(body, "tin")
        ? body.tin
        : currentTenant.tin,
    ...
    nationalId:
      Object.prototype.hasOwnProperty.call(body, "nationalId")
        ? body.nationalId
        : currentTenant.nationalId,
  };

  await Tenant.update(personalInfoUpdate, {
...
exports.updateTenant = async (req, res) => {
  try {
      ...
      const oldPhoneNumber = tenant.phoneNumber;
