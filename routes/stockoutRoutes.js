...
const { verifyToken,employeeAuth,adminAuth,adminOrEmployeeAuth } = require("../middleware/auth"); // Ensure verifyToken is exported in authMiddleware
...
// router.get("/export", verifyToken, stockoutController.exportStockoutReport);
