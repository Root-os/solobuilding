...
const defineAssociations = () => {
  ...
  BillPayment.belongsTo(BillType, {
    foreignKey: "billTypeId",
    onDelete: "CASCADE",
    onUpdate: "CASCADE",
  });
  BillType.hasMany(BillPayment, {
    foreignKey: "billTypeId",
    onDelete: "CASCADE",
    onUpdate: "CASCADE",
  });

  ElectricCarCharging.belongsTo(Tenant, {
    foreignKey: "tenantId",
    onDelete: "CASCADE",
  });
  Tenant.hasMany(ElectricCarCharging, {
    foreignKey: "tenantId",
    onDelete: "CASCADE",
  });
  ...
  PaymentRequest.belongsTo(Tenant, {
    foreignKey: "tenantId",
    onDelete: "CASCADE",
  });
  PaymentRequest.belongsTo(BillType, {
    foreignKey: "billTypeId",
    onDelete: "CASCADE",
  });

  BillType.hasMany(TenantPayment, {
    foreignKey: "billTypeId",
    onDelete: "CASCADE",
  });
  TenantPayment.belongsTo(BillType, {
    foreignKey: "billTypeId",
    onDelete: "CASCADE",
  });

  Tenant.hasMany(TenantPayment, {
    foreignKey: "tenantId",
    onDelete: "CASCADE",
  });
  TenantPayment.belongsTo(Tenant, {
    foreignKey: "tenantId",
    onDelete: "CASCADE",
  });

  Tenant.hasMany(TenantRentCollection, {
    foreignKey: "tenantId",
    onDelete: "CASCADE",
  });
  TenantRentCollection.belongsTo(Tenant, {
    foreignKey: "tenantId",
    onDelete: "CASCADE",
  });
  ...
  Tenant.hasMany(TenantVehicle, {
    foreignKey: "tenantId",
    onDelete: "CASCADE",
  });
  TenantVehicle.belongsTo(Tenant, {
    foreignKey: "tenantId",
    onDelete: "SETNULL",
  });
  ...
  Tenant.hasMany(WithdrawalRequest, {
    foreignKey: "tenantId",
    onDelete: "CASCADE",
  });
  ...
  Purchase.belongsTo(ItemCategory, {
    foreignKey: "ItemCategoryId",
    onDelete: "CASCADE",
  });
  ItemCategory.hasMany(Purchase, {
    foreignKey: "ItemCategoryId",
    onDelete: "CASCADE",
  });

  purchaseRequest.belongsTo(Item, {
    foreignKey: "itemId",
    as: "item",
    onDelete: "CASCADE",
  });
  Item.hasMany(purchaseRequest, {
    foreignKey: "itemId",
    as: "item",
    onDelete: "CASCADE",
  });
  ...
  itemAssignments.belongsTo(Item, {
    foreignKey: "itemId",
    as: "item",
    onDelete: "CASCADE",
  });
  Item.hasMany(itemAssignments, {
    foreignKey: "itemId",
    as: "items",
    onDelete: "CASCADE",
  });

  itemAssignments.belongsTo(User, {
    foreignKey: "assignedId",
    as: "assignto",
    onDelete: "CASCADE",
  });
  User.hasMany(itemAssignments, {
    foreignKey: "assignedId",
    as: "assignto",
    onDelete: "CASCADE",
  });

  Maintenance.belongsTo(Item, {
    foreignKey: "itemId",
    as: "maintenanceItem",
    onDelete: "CASCADE",
  });
  Item.hasMany(Maintenance, {
    foreignKey: "itemId",
    as: "itemMaintenances",
    onDelete: "CASCADE",
  });
  ...
  Vendor.belongsTo(ServiceType, {
    foreignKey: "serviceTypeId",
    onDelete: "CASCADE",
  });
  ServiceType.hasMany(Vendor, {
    foreignKey: "serviceTypeId",
    onDelete: "CASCADE",
  });
  ...
  purchaseRequest.belongsTo(Vendor, {
    foreignKey: "vendorId",
    as: "vendor",
    onDelete: "CASCADE",
  });
  Vendor.hasMany(purchaseRequest, {
    foreignKey: "vendorId",
    as: "vendor",
    onDelete: "CASCADE",
  });

  LetterResponse.belongsTo(Tenant, {
    foreignKey: "tenantId",
    onDelete: "CASCADE",
  });
  Tenant.hasMany(LetterResponse, {
    foreignKey: "tenantId",
    onDelete: "CASCADE",
  });

  LetterResponse.belongsTo(Letter, {
    foreignKey: "letterId",
    onDelete: "CASCADE",
  });
  Letter.hasMany(LetterResponse, {
    foreignKey: "letterId",
    onDelete: "CASCADE",
  });
  ...
  TenantInventory.hasMany(TenantItem, {
